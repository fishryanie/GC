  ...
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-4">
      <section className="rounded-2xl border border-border bg-background-secondary p-5">
        <p className="m-0 text-xs font-semibold uppercase tracking-[0.12em] text-foreground-muted">
          {t("tag")}
        </p>
      ...
      <form
        ...
        className="space-y-4 rounded-2xl border border-border bg-background-secondary p-5"
      >

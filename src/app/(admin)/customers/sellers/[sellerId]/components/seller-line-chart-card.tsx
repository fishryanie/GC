...
type SellerLineChartCardProps = {
  title: string;
  subtitle?: string;
  labels: string[];
  series: SellerTrendSeries[];
  toolbar?: ReactNode;
  emptyLabel?: string;
  className?: string;
};
...
export function SellerLineChartCard({ title, subtitle, labels, series, toolbar, emptyLabel = 'No data', className }: SellerLineChartCardProps) {

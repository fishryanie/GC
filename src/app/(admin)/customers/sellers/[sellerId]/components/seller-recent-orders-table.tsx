        ...
        <table className='w-full min-w-[980px] border-collapse text-xs'>
          <thead className='bg-background-tertiary/70 text-foreground-muted'>
            <tr className='border-b border-border'>
              <th className='px-3 py-2 text-left font-semibold uppercase tracking-[0.06em]'>{t('sellers.details.recentTable.invoice')}</th>
            ...
            {orders.map(order => (
              <tr key={order.id} className='border-b border-border align-top last:border-b-0 hover:bg-background-tertiary/50'>
                <td className='px-3 py-2'>
                  <span className='inline-flex rounded border border-border bg-background-secondary px-1.5 py-0.5 font-mono text-[10px] font-semibold text-foreground'>
                    {order.code}
                  </span>
                </td>
                <td className='min-w-[260px] px-3 py-2'>
                  ...
                  <div className='mt-0.5 flex items-center gap-2 text-[11px] text-foreground-muted'>
                    ...
                    <button
                      ...
                      className='rounded border border-border bg-background-secondary px-1.5 py-0.5 text-[10px] font-medium text-foreground-secondary transition-colors hover:text-foreground'>
                      {t('sellers.details.recentTable.viewDetails')}
                    </button>
                  </div>
                </td>
                ...
                <td className='whitespace-nowrap px-3 py-2'>
                  <div className='flex items-center gap-1.5'>
                    <button
                      type='button'
                      onClick={() => setSelectedOrder(order)}
                      className='rounded-md border border-border bg-background-secondary px-2 py-1 text-[11px] font-medium text-foreground-secondary transition-colors hover:text-foreground'>
                      {t('sellers.details.recentTable.viewDetails')}
                    </button>
                    <button
                      type='button'
                      onClick={() => handleExportInvoice(order)}
                      className='inline-flex items-center gap-1 rounded-md border border-primary-500/35 bg-primary-500/10 px-2 py-1 text-[11px] font-medium text-primary-200 transition-colors hover:border-primary-500/50 hover:bg-primary-500/15 hover:text-primary-100'>
                      <Download className='h-3.5 w-3.5' />
                      {t('sellers.details.recentTable.exportInvoice')}
                    </button>
                  </div>
                </td>
              </tr>
